...
session.mount('https://', HTTPAdapter(max_retries=Retry(connect=5, backoff_factor=1)))
...
def main():
    with open("parsed-christies_2.csv", 'w+', newline='', encoding="utf-8") as write_file:
        writer = csv.DictWriter(write_file, fieldnames=["Author", "Art", "Sale date", "Price", "Size",
                                                        "Style", "Estimate", "Provenance", "Sign", "Collection",
